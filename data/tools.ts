...
export const tools: Tool[] = [
  ...
  { id: "x-grok-3", name: "Grok 3 (X.AI)", description: "Real-time Twitter integration. Best for breaking news and cultural context.", category: "Chat", url: "https://x.ai", pricing: "Paid", featured: false, badge: "🐦 Real-time", color: "bg-gray-900", iconName: "Twitter", keywords: ["chat", "news", "twitter", "real-time", "social", "ai"] },
